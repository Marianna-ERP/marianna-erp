...
exports.resolveFxRate = exports.defaultFxRate = exports.FX_RATES = void 0;
exports.FX_RATES = {
    PLN: 1,
    EUR: 4.2531,
    USD: 3.8812,
...
function defaultFxRate(currency) {
    if (!currency)
        return 1;
    const r = exports.FX_RATES[String(currency).toUpperCase()];
    return r && isFinite(r) ? r : 1;
}
exports.defaultFxRate = defaultFxRate;
...
function resolveFxRate(explicit, currency) {
    const e = parseFloat(String(explicit !== null && explicit !== void 0 ? explicit : "").replace(",", "."));
    if (isFinite(e) && e > 0)
        return e;
    return defaultFxRate(currency);
}
exports.resolveFxRate = resolveFxRate;
